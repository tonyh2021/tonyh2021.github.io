...
export default function MobileFloatingControls() {
  ...
  useLayoutEffect(() => {
    const stored = localStorage.getItem("tony-blog-dark");
  ...
  const toggleDark = () => {
    ...
    localStorage.setItem("tony-blog-dark", next ? "1" : "0");
  };
  ...
  return (
    <>
      ...
      <div className="fixed top-4 right-4 z-50 flex items-center gap-1">
        ...
        >
          {/* Both icons in HTML; CSS dark: class controls which is visible — no JS flash */}
          <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hidden dark:block">
          ...
          <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="block dark:hidden">
