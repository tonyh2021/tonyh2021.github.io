  ...
  return (
    <div className="h-full overflow-y-auto bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      <div className="max-w-lg mx-auto px-6 py-8">
        ...
        <blockquote className="my-6 pl-4 border-l-4 border-indigo-500 italic text-gray-600 dark:text-gray-400">
          And one more thing…
        </blockquote>
        ...
        <p className="text-sm text-right text-gray-500 dark:text-gray-500 mb-8">
          — Steve Jobs
        </p>
      </div>
    </div>
