...
function NavSection({
  ...
  return (
    <div className="mx-auto w-full max-w-screen-md px-4 pt-8">
    ...
    >
      <div className="w-full min-h-full pt-6 pb-16 bg-white/80 dark:bg-gray-900/80 backdrop-blur-2xl">
        <NavSection
          ...
          cols={Math.min(cols, websites.favorites.sites.length)}
        />
        <NavSection
    ...
    <div className="w-full h-full flex flex-col">
      ...
      <div className="flex-1 overflow-hidden">
        {!wifi ? (
          ...
          <HomePage onNavigate={navigate} width={width} />
        ) : (
          <iframe
            src={activeURL}
            title="Safari"
